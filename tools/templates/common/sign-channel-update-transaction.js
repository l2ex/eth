...
module.exports = function(channelOwner, token, change, nonce, r, s, v, senderNonce, senderAddress, senderPrivateKey) {
    const contract = new web3.eth.Contract(contractAbi, contractAddress)
    const bytecode = contract.methods.pushOffchainBalanceChange(channelOwner, token, change, nonce, r, s, v).encodeABI()
    var tx = new ethTx({
